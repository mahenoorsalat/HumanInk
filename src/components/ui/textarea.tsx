  ...
  "flex min-h-[80px] w-full rounded-lg border bg-background px-4 py-3 text-base ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200 md:text-sm",
  {
    variants: {
      variant: {
        ...
        glass: "border-border/50 bg-card/50 backdrop-blur-sm focus:border-primary/50",
        editor: "border-border bg-secondary/30 focus:bg-secondary/50 focus:border-primary/50 min-h-[200px] resize-none font-mono",
      },
    },
    defaultVariants: {
      variant: "default",
